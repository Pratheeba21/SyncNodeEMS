...
// // Recharts imports for the Task Center Workflow
// import {
//   PieChart,
//   Pie,
//   Cell,
...
// } from "recharts";
// // Chart.js imports for the main dashboard
...
// import ChatDrawer from "./ChatDrawer"; // Import Chat component

// const API_URL = "http://localhost:5000/api";
// const SOCKET_URL = "http://localhost:5000"; // Define your backend URL
...
//   const [socket, setSocket] = useState(null); // 2. State to hold the socket instance

//   useEffect(() => {
//     const newSocket = io(SOCKET_URL, {
//       auth: { token }, // Pass token if your backend requires auth for sockets
//     });
//     setSocket(newSocket);
...
//           </button>
//           {/* 2. Added EOD Reports Nav Button */}
//           <button
...
//               </button>
//               <button
//                 onClick={() => setCurrentPage("admin-assign-task")} // New ID
...
//               className={`nav-link ${
//                 currentPage === "admin-approvals" ? "active" : ""
//               }`}>
...
//         )} */}
//         {currentPage === "messenger" &&
//           socket && ( // Only render if socket is ready
//             <ChatDrawer
//               socket={socket}
//               user={user}
//               isOpen={true}
...
// export default function AdminDashboard({ token, user, showToast, logout }) {
//   const [currentPage, setCurrentPage] = useState("dashboard");
//   const [pulse, setPulse] = useState(user.pulseStatus || "Available"); // Initialize from user data
//   const [attendance, setAttendance] = useState(null);
//   const [timer, setTimer] = useState("00:00:00");
...
//   // NEW: Sync Pulse Status to Database
//   useEffect(() => {
...
//     // Prevent update on initial mount if it matches current status
//     if (pulse) {
//       updatePulseInDB();
//     }
//   }, [pulse, token]);
